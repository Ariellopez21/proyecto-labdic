    ...
    >
      <div v-if="mobileMenuOpen" class="md:hidden border-t border-gray-200 mt-3 pt-3">
        <a
          ...
          :key="item.label"
          href="#"
          class="flex items-center px-4 py-2.5 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-md transition-colors w-full text-left"
