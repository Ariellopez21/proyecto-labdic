...
<template>
  <div class="page-container">
    ...
    <div class="page-header">
      ...
      <Button icon="pi pi-plus" label="Nueva solicitud" @click="$router.push({ name: 'catalog' })" />
    </div>
        ...
        <DataTable :value="loans" :loading="loading" dataKey="id" stripedRows>
          ...
          <template #empty>
            <div class="text-center py-8 text-muted-color">
              ...
              <div class="mt-2">
                <Button label="Ir al catálogo" severity="secondary" outlined size="small"
    ...
    <!-- Drawer -->
    <Drawer v-model:visible="showDrawer" header="Detalle de solicitud" position="right" style="width: 480px">
