\section{Implementación de base de datos y backend del sistema}
...
ello, el DTO excluye explícitamente campos como \ttt{loan\_request\_items.loan\_request}, 
\ttt{loan\_request\_items.device.loan\_request\_items} y otros que cierran el ciclo, 
