\section{Implementación del frontend del sistema}
...
% -------------------------------------------------------
\subsection{Fase 1: Módulo de Usuarios y Autenticación}\label{sec:hito4_frontend_fase_1}
...
% -------------------------------------------------------
\subsection{Fase 6: UX, UI}\label{sec:hito4_frontend_fase_6}
...
Las evidencias visuales de las 6 fases de desarrollo e implementación del frontend 
se encuentran consolidadas en el anexo~\ref{sec:anexo_evidencias}, donde se 
presentan todas las pantallas y vistas funcionando tal como se describen en las 
secciones~\ref{sec:hito4_frontend_fase_1} a~\ref{sec:hito4_frontend_fase_6}.
Con esto concluye la implementación del sistema, el cual, al ser modular y 
escalable, abre paso a mejoras y extensiones futuras descritas en la 
