...
\subsection{Mejoras al proyecto actual}\label{sec:mejorar_proyecto_actual}
...
\emph{Expiración automática de cuentas}
...
\subsubsection*{Módulo de Préstamos}

\emph{Cancelación de solicitudes por el usuario}
...
\emph{Catálogo agrupado por producto}
...
\emph{Serialización correcta del DTO de préstamos}
...
\emph{\texttt{DeviceForm} reutilizable}
...
\emph{Botones de \texttt{ProductDetailView}}
...
\emph{Drawer para ver detalles de usuario}
...
\emph{Perfil personalizable en \texttt{MyUserView}}
...
% -------------------------------------------------------
\subsection{Nuevos módulos propuestos}
...
\subsubsection{Préstamo de Inventario (continuación)}
...
\subsubsection{Administración de Inventario}
...
\subsubsection{Administración de Salas}
...
% -------------------------------------------------------
\subsection{Resumen y recomendaciones}
